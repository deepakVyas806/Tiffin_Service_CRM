...
export const adminNav = [
  ...
  { to: "/admin/kitchen-schedule", label: "Kitchen Schedule", icon: CalendarDays, testid: "side-admin-kitchen", permission: "kitchen:manage" },
  { to: "/admin/menu", label: "Meal Management", icon: ChefHat, testid: "side-admin-menu", permission: "meals:manage" },
